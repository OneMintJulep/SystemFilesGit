...
-- Main ------------------------------------------------------------
DIR = "~/.config/awesome/themes/BW"
theme = {}
theme.font          = "sans 8"
theme.wallpaper  = DIR .. "/img/water_foam_on_water_Left.jpg"
theme.wallpaper2 = DIR .. "/img/water_foam_on_water_Right.jpg"
--------------------------------------------------------------------
