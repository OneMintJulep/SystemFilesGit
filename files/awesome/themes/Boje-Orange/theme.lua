...
-- Main ------------------------------------------------------------
DIR = "~/.config/awesome/themes/Boje-Orange"
theme = {}
theme.font          = "sans 8"
theme.wallpaper = DIR .. "/img/background.jpg"
--------------------------------------------------------------------
...
--theme.taglist_bg_focus = "#ff0000"
theme.tasklist_bg_focus = "#15000000"
...
theme.awesome_icon = DIR .. "/img/icons/arch24.png"
